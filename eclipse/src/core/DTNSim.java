...
public class DTNSim {
	...
	public static void main(String[] args) {
		...
		* */
		...
		try {
			// gracefully shut down thread pool at the end of the simulation
			SimulationConfig.SIMULATION_THREADS.shutdown();
			while (!SimulationConfig.SIMULATION_THREADS.awaitTermination(1, TimeUnit.MINUTES))
				;
		} catch (Exception e) {
			DeviceLog.e(null, "ERROR DTNSim", "Error shutting down thread pool!", e);
		}
		/**
		* END AUTHENTICATION
		* */
