...
public class BloomFilterFingerprint {
	...
	public BloomFilterFingerprint(int log2noBits, int noHashes) {
	...
	public BloomFilterFingerprint(int noItems, int bitsPerItem, int noHashes) {
